...
class CharDefaultValueCorrectionApplier : CorrectionApplier<DefaultValue, Char> {
    ...
    override fun correct(value: Char?, context: CorrectionApplierContext?): CorrectionApplierResult<Char> {
        return if (value == null) {
            CorrectionApplierResult.Edited(
                oldValue = value,
                newValue = annotation.charValue,
            )
        } else {
