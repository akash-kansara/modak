...
class DoubleDefaultValueCorrectionApplier : CorrectionApplier<DefaultValue, Double> {
    ...
    override fun correct(value: Double?, context: CorrectionApplierContext?): CorrectionApplierResult<Double> {
        return if (value == null) {
            CorrectionApplierResult.Edited(
                oldValue = value,
                newValue = annotation.doubleValue,
            )
        } else {
